...
Retail + Customer + Orders + Employee + Web Traffic SQL Analytics Project
📌 Project Overview

This SQL project demonstrates end-to-end data analysis using multiple relational tables — retail sales, customers, orders, employees, and website traffic.
It includes table creation, data insertion, data validation, and 15 real-world analyst queries using GROUP BY, JOINs, Window Functions, CASE statements, and Date/Time functions.

This project is ideal for Data Analyst / SQL Analyst portfolio building.

🎯 Objectives

Create and populate five relational tables

Perform analysis using SQL

Solve 15 business-oriented SQL questions

Showcase SQL mastery with window functions, aggregation, date functions, joins, and ranking
...
2. Top 3 highest selling products by revenue
...
3. Identify morning, afternoon, evening orders
SELECT *,
       CASE
...
4. Count number of orders by each customer
SELECT customer_id, COUNT(*) AS total_orders
FROM retail_sales
GROUP BY customer_id;

5. Highest sales day of each month
SELECT *
FROM (
        SELECT
...
6. Customers who haven't made any purchase
...
7. Count customers grouped by city
...
11. 2nd highest total order amount (window function)
...
This SQL project covers a wide range of essential analyst skills:
...
It provides a strong portfolio-ready demonstration of SQL capabilities.

✍️ Author

Vitthal Bidve

If you'd like improvements, visualizations, or want this published as a GitHub repository with folder structure, just tell me — I’ll generate everything.
